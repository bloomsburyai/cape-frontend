<style scoped lang="scss">
  ...
  .cape-dashboard-dropdown-content-layout {
    ...
    .cape-dashboard-dropdown-icon-label-option:first-child,
    .cape-dashboard-dropdown-label-option:first-child {
      margin-top: 0.1875rem;
    }

    .cape-dashboard-dropdown-icon-label-option:last-child,
    .cape-dashboard-dropdown-label-option:last-child {
...
<template>
  <div class="cape-dashboard-dropdown-content-layout"
