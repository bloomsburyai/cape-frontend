...
<template>
  <div class="cape-landing-terms-modal">
    <div class="cover"></div>
    <div class="body">
        ...
        <div class="content">
          <div class="page-wrapper">
            <div class="page">
              ...
              <h6>Data</h6>
              <p>Bloomsbury AI’s Services do not need personal data to operate. The User should not upload or give us access to personal data, this means the User should use non-personal emails, non-personal login accounts and accessing the service behind an anonymous proxy to hide their IP.
              If the User uploads by mistake personal data,the User should contact Bloomsbury AI as soon as possible so we can delete the data.
              </p>
