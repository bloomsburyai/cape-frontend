<style scoped lang="scss">
  ...
  .cape-dashboard-dashed-container .line {
    position: absolute;
  }

  .cape-dashboard-dashed-container .line-top {
    top: 0;
    right: 0;
    left: 0;
    height: 1px;
  ...
  .cape-dashboard-dashed-container .line-bottom {
    right: 0;
    bottom: 0;
    left: 0;
    height: 1px;
  ...
  .cape-dashboard-dashed-container .line-left {
    top: 0;
    bottom: 0;
    left: 0;
    width: 1px;
  ...
  .cape-dashboard-dashed-container .line-right {
    top: 0;
    right: 0;
    bottom: 0;
    width: 1px;
  ...
  .cape-dashboard-dashed-container .content {
    height: 100%;
    margin: 1px;
  }
...
<template>
  <div class="cape-dashboard-dashed-container">
    <span
